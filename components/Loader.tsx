...
const CRITICAL = ["/images/hero-family.png", "/window.png", "/images/logo/logo-acik-zemin.png"];
  ...
  return (
    <div className={`site-loader${done ? " is-done" : ""}`} aria-hidden={done}>
      <div className="site-loader-inner">
        <NextImage
          src="/images/logo/logo-acik-zemin.png"
          alt="myviptransfer — Her Karşılama Özel, Her Yolculuk VIP"
          width={900}
          height={280}
          priority
